...
?>
<form class="products-filter mobi filtersForm" action="" method="get" style="display: none;">
    ...
    <div class="products-filter__col">
        ...
        <div class="products-filter__wrap">
            <label class="products-filter__input-wrap"><span class="products-filter__sublabel"><?php pll_e('От'); ?></span>
                <input name="height_from" value="<?= $height_from; ?>" class="products-filter__input" type="number">
            </label>
            <label class="products-filter__input-wrap"><span class="products-filter__sublabel"><?php pll_e('До'); ?></span>
